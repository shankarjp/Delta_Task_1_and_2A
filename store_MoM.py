...
mydb=mysql.connector.connect(host="localhost",user="Jay_Jay",password="password")
...
if "store_MoMs" not in mycursor:
	mycursor.execute("CREATE TABLE store_MoMs (name VARCHAR(255) AUTO_INCREMENT PRIMARY KEY, dates VARCHAR(255), content TEXT)")
